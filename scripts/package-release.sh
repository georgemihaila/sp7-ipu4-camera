...
cp -p "$ROOT/scripts/ir/sp7_ir_protocol.py" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/sp7_ir_reader.py" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/howdy-sp7-ir-diagnostic.py" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/howdy-revision.txt" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/howdy-models.sha256" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/howdy-sp7-ir-config.ini" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/howdy-sp7_ir.patch" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/build-howdy-runtime.sh" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/howdy-preflight.sh" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/prepare-howdy-prelogin.sh" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/pam-howdy-isolated" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/install-isolated-pam-test.sh" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/prepare-gdm-pam.sh" "$STAGE/scripts/ir/"
cp -p "$ROOT/scripts/ir/selinux-howdy-diagnostics.sh" "$STAGE/scripts/ir/"
